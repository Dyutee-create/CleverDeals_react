...
module.exports.OwnersSignUpEmail = function(request,response,next) {
    console.log("Inside OwnersSignUpEmail request");
    ...
    var passwordHash;
        ...
        MongoClient.connect(url, (err, client) => {
            if(err) {
                ...
                db.collection('OwnersSignUpEmail').insertOne({
                    firstName : firstName,
                    lastName : lastName,
                    emailID : emailID,
                    ...
                    if(err) {
                        ...
                        db.collection('OwnersSignIn').insertOne({
                            emailID: emailID,
                            password : passwordHash
                        }, (err, result) => {
                            if(err) {
