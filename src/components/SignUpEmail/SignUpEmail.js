...
class SignUpEmail extends Component{
    ...
    submitLogin = (e) => {
        ...
        e.preventDefault();
        //check this code it might give error
        this.updateState();
    ...
    validateForm() {
        ...
        this.updateState.formIsValid = true
        //this.state.formIsValid = "true";
        if (!fields["firstname"]) {
            //this.state.formIsValid = false;
            this.updateState.formIsValid = false
        ...
        return(
            <div class="signupemail-first-div">
                ...
                <div class="row signupemail-row">
                    <div class="col-sm-11">
                        <img class="signupemail-image1" height="60" width="175" alt='' src={require("../Images/logo3.png")}/>
                    </div>
                    <div class="col-sm-1">
                    ...
                    <div class="signupemail-entire-thing">
                        ...
                        <div class="signupemail-form">
                            <div class="signupemail-div"> 
                                ...
                                <div>
                                    <label><img class="signupemail-fb" height="49" width="330" alt='' src={require('../Images/fb.png')}/></label>
                                    <label><img class="signupemail-google" height="48" width="330" alt='' src={require('../Images/google.png')}/></label>             
                                </div>
