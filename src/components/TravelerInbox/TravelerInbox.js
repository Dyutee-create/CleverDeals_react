...
class TravelerInbox extends Component {
    ...
    componentDidMount(){
        axios.get('http://localhost:3000/TravelerInbox')
                .then((response) => {
        ...
        return(
            <div class="travelerinbox-first-div">
                <div class="row travelerinbox-row1">
                    <div class="col-sm-5">
                        <Link to="/"><img height="50" width="175" alt='travel-inbox' src={require("../Images/HomeAway.png")}/></Link>
                    </div>
                    ...
                    <div class="col-sm-1 travelerinbox-logo-col2">
                        <img height="50" width="50" alt='travel-inbox-logo' src={require("../Images/logo1.png")}/>
                    </div>
                </div>
